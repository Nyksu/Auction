...
width="100%" bgcolor="#3E0909" bordercolor="#330000">
  <tbody> 
  <tr> 
    <td width=150> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table border=1 bordercolor=#3E0909 cellpadding=0 cellspacing=0 width="100%">
    ...
    <td colspan=2 width="830"> 
      <h1><b>:: Личный кабинет :: </b><a href="support.asp">Поддержка</a> </h1>
      </td>
    </tr>
    </tbody> 
  </table>
  <table width="100%" border="0" bordercolor="#330000" cellspacing="0">
    <tr> 
      <td height="2"><b><font color="#000066" face="Arial, Helvetica, sans-serif" size="3"><%=host_lot%></font></b></td>
    </tr>
  </table>
  <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#3E0909">
    <tr bordercolor="#FFCC99"> 
      ...
      <td colspan="2" bgcolor="#FFCC99" bordercolor="#FFCC99"> 
        <h1>:: <a href="area.asp"><b>Лоты, торги на которые продолжаются !</b></a></h1>
        </td>
    </tr>
  </table>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="1" bordercolor="#330000" cellspacing="2">
    <tr bordercolor="#FFFFFF"> 
      <td bgcolor="#FFCC99" width="50%" bordercolor="#330000"> 
        <div align="center">
        <h1>-- ВАШИ ЛОТЫ (торги на которые закончились)--</h1>
      </div>
      </td>
    </tr>
    <tr bordercolor="#FFFFFF" valign="top"> 
      ...
      <p align="center"><b><font color="#FF0000">ВНИМАНИЕ!! ЭТИ ЛОТЫ СРОЧНО ТРЕБУЮТ 
        ВАШЕГО ВНИМАНИЯ!!</font></b></p>
        <p align="center"><b>Необходимо &quot;Обработать&quot; лоты имеющие ставки, 
          &quot;Удалить&quot; или &quot;Продлить&quot; те лоты, по которым ставок 
          нет!!</b></p>
        <div align="center">
          <%
		sql=end_own_lots
        ...
        <table width="100%" border="1" bordercolor="#330000">
          <tr bordercolor="#BDCECE" bgcolor="#BDCECE"> 
            <td colspan="3"> 
              <p><font size="1"><b><img src="<%="Images/"+nam_img+".gif"%>" width="16" height="16" align="absmiddle" alt="<%=tip_nam%>"></b> 
                (лот № <%=lot_id%>)</font> <a href="auction.asp?subj_id=<%=subj_id%>&lot_id=<%=lot_id%>"><%=name_lot%></a> <b><font size="2"> (<a href="auction.asp?subj_id=<%=subj_id%>"><%=name_subj%></a>)</font></b> </p>
            </td>
          </tr>
          <tr bordercolor="#BDCECE" bgcolor="#FFFFFF"> 
            <td height="2"> 
              <p>Кол-во участников: <%=kvo_memb%> <%=kvo_stavok==0?" -  Ставок нет!":" -  Принято ставок: "+kvo_stavok%></p>
            </td>
            <td height="2"> 
              <p>дата окончания: <font color="#3333FF"><%=end_date%></font></p>
            </td>
            <td height="2"> 
              <p><b>Текущая цена лота:</b><font color="#3333FF"> <b><font color="#FF0000"><%=tek_price%></font> <%=valuta%> </b></font></p>
            </td>
          </tr>
          <tr bgcolor="#BDCECE" bordercolor="#BDCECE"> 
            <td colspan="3" height="16"> 
              <p align="center"> 
                <%if (kvo_stavok>0) {%>
                <b><a href="proc_lot.asp?subj=<%=subj_id%>&lot=<%=lot_id%>">ОБРАБОТАТЬ 
                ЛОТ</a> 
                <%}%>
                </b> <a href="del_lot.asp?subj=<%=subj_id%>&lot=<%=lot_id%>">Удалить 
                </a> 
                <%if (kvo_stavok==0) {%>
                <a href="prolong_lot.asp?subj=<%=subj_id%>&lot=<%=lot_id%>"> 
                Продлить </a> 
                <%}%>
              </p>
            </td>
